     ...
     class Config{
        ...
        public function connect(){
         ...
         public function insert($name){
               ...
               $query = "INSERT INTO $this->BOOK_TABLE(name) VALUES ('$name');";
         ...
         public function fetchSingleRecord($id){
           ...
           $query = "SELECT * FROM $this->BOOK_TABLE WHERE id=$id;";
         ...
         public function delete($id){
            ...
            if($isRecordAvailable){
                $query = "DELETE FROM $this->BOOK_TABLE WHERE id=$id;";
         ...
         public function update($name, $id){
            ...
            $query = "UPDATE $this->BOOK_TABLE SET name='$name' WHERE id=$id;";
